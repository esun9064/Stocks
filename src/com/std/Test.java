...
public class Test extends JFrame implements ActionListener, KeyListener {
	...
	*/
	...
	public final void show_hist_data(YStockQuote x, DayRange b) {
		x.getIntraday();
	...
	public Test()
	{
		...
		main.add(stockInfoPanel, BorderLayout.CENTER);
	...
	public static void main(String args[])
	{
		...
		FavoritesPanel n = new FavoritesPanel();
	...
	public void getNewStock()
	{
		...
		remainingInfoTable.packColumn(0, 2);
		remainingInfoTable.packColumn(1, 2);
